...
public class PlayerWallBlock : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        m_CharacterController.center = new Vector3(m_LocalHeadTransform.localPosition.x, m_CharacterController.center.y - offset, m_LocalHeadTransform.localPosition.z);
